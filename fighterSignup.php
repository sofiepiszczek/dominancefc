...
<div class="container">
    <div class="row justify-content-center text-center">
        <div class="col-md-6">
            ...
            <p class="px-4">Do you have what it takes to perform at the top level, and compete with some of the best and
                most prominent fighters in the world?</p>
        </div>
        ...
        <div class="row justify-content-center text-start">
            ...
            <div class="col-md-5 px-4 mt-5">
                ...
                <input type="date"
                       class="form-control bg-white custom-text text-secondary placeholder-gray py-3 custom-placeholder"
                       placeholder="INSERT DATE OF BIRTH HERE">
            </div>
            ...
            <div class="col-md-5 px-4 mt-5">
                ...
                <input type="number" class="form-control bg-white custom-text text-secondary placeholder-gray py-3"
        ...
        <div class="row justify-content-center">
            <div class="col-md-5 px-4 mt-5">
                <input type="text"
                       class="form-control custom-text border-0 border-bottom bg-transparent text-white placeholder-gray text-center my-5 underline"
                       style="box-shadow: none" placeholder="FACEBOOK LINK">

                <input type="text"
                       class="form-control custom-text border-0 border-bottom bg-transparent text-white placeholder-gray text-center my-5 underline"
                       style="box-shadow: none" placeholder="INSTAGRAM LINK">

                <input type="text"
                       class="form-control custom-text border-0 border-bottom bg-transparent text-white placeholder-gray text-center my-5 underline"
                       style="box-shadow: none" placeholder="TWITTER LINK">

                <input type="text"
                       class="form-control custom-text border-0 border-bottom bg-transparent text-white placeholder-gray text-center my-5 underline"
                       style="box-shadow: none" placeholder="LINKEDIN LINK">

                <input type="text"
                       class="form-control custom-text border-0 border-bottom bg-transparent text-white placeholder-gray text-center my-5 underline"
                       style="box-shadow: none" placeholder="YOUTUBE LINK">
            </div>
        </div>

        <div class="reveal row justify-content-center">
            <div class="col-md-4 px-4 mt-5">
                <p class="px-4 fw-bold text-start">Do you allow us to save your info for future events and agree to our
                    privacy policy, marketing, and tracking? You can withdraw consent anytime.</p>
            </div>
        </div>
