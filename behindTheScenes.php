...
<div class="container">
    <div class="row text-center justify-content-center align-items-center">
        ...
        <div class="col-12 pb-5">
            <p class="px-4 px-lg-0 text-white h5 fw-bold">Take a look behind the scenes from previous events!</p>
        </div>

        <div class="col-12 col-md-6 px-4 pb-5 reveal">
            <p class="h6 text-white text-start ps-4 custom-text">BTS DFC 1.0</p>
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/05Hn8hPdTV8?si=tABE9XS9vuJLghLj" class="p-lg-3 p-md-2 p-1"
        ...
        <div class="col-12 col-md-6 p-4 pb-5 reveal">
            ...
            <div class="ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/RBqi4cHE-I8?si=TeE1IX3xrFd4qMJv" class="p-lg-3 p-md-2 p-1"
                        title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
