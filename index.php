    ...
    <div class="row">
        <div class="col-12 d-inline-flex flex-wrap justify-content-center align-items-center bg-primary bg-opacity-25 text-center custom-text py-5">
            <div class="nextEvent col-11 col-md-8 col-lg-5 card shadow-lg rounded-0 bg-secondary my-4 me-lg-4 reveal">
                ...
                <p class="fs-4 text-primary">26/04/2025</p>
                <div class="px-3 pb-3 px-md-5 pb-md-5">
            ...
            <div class="nextAcademy col-11 col-md-8 col-lg-5 card shadow-lg rounded-0 bg-secondary my-4 ms-lg-4 reveal">
                <h2 class="pt-3 pt-md-4 fs-2">NEXT ACADEMY</h2>
                <p class="fs-4 text-primary">09/08/2025</p>
                <div class="px-3 pb-3 px-md-5 pb-md-5">
        ...
        <div class="container banner position-relative gx-0 mb-5">
            <a href="ppv.php">
            <img src="images/plutobanner.jpg" class="img-fluid position-absolute object-fit-cover h-100 w-100" alt="mma fighter">
        ...
        <div class="container-fluid">
            ...
            <div class="reveal col-12 text-center ratio ratio-16x9">
                <iframe src="https://www.youtube.com/embed/05Hn8hPdTV8?si=USDIU4UFjy8bQ6pw" class="" title="YouTube video player"
            ...
            <div class="col-12 text-white text-center pt-5 reveal">
                <h2 class="fs-1 pt-4 pb-2 custom-text">BE FAMILY!</h2>
                <h6 class="pb-3 ">Stay in the loop - get our newsletter</h6>

                <form class="d-inline-flex justify-content-center flex-wrap">
                    <div class="col-12 mb-3 d-flex justify-content-center">
                        <div class="col-10 col-md-5">
                        <input type="email" class="form-control py-2 py-md-3 text-white custom-text placeholder-gray rounded-0 bg-white" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="E-MAIL">
                        </div>
                    </div>
                    <div class="col-12 pb-3 p-md-3">
                    <button type="submit" class="btn btn-primary text-white px-5 px-md-3 px-lg-5 custom-text">SUBSCRIBE</button>
                    </div>
